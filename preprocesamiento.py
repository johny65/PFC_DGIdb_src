from datos_preprocesamiento import cargar_publicaciones, cargar_abstracts, cargar_ocurrencias, cargar_aliases_dict
import pathlib
import sys
import argparse
...
if __name__ == "__main__":
    ...
    publicaciones_dict = cargar_publicaciones(args.dir_txt_publicaciones, abstracts_dict, args.lista_pmid)
    ...
    ocurrencias_genes_se_sr = cargar_ocurrencias(dir_pfc_dgidb / "ocurrencias_genes_se_sr.csv")
    ocurrencias_genes_se_cr = cargar_ocurrencias(dir_pfc_dgidb / "ocurrencias_genes_se_cr.csv")
    ocurrencias_genes_todas = cargar_ocurrencias(dir_pfc_dgidb / "ocurrencias_genes_todas.csv")
    # ocurrencias_drogas_se_sr = cargar_ocurrencias(dir_pfc_dgidb / "ocurrencias_drogas_se_sr.csv")
    ocurrencias_drogas_se_cr = cargar_ocurrencias(dir_pfc_dgidb / "ocurrencias_drogas_se_cr.csv")
    ocurrencias_drogas_todas = cargar_ocurrencias(dir_pfc_dgidb / "ocurrencias_drogas_todas.csv")
